...
def update_teacher_view(request, pk):
    ...
    user_form = TFORM.TeacherUserForm(instance=user)
    teacher_form = TFORM.TeacherForm(request.FILES, instance=teacher)
    mydict = {'userForm': user_form, 'teacherForm': teacher_form}

    if request.method == 'POST':
        user_form = TFORM.TeacherUserForm(request.POST, instance=user)
        teacher_form = TFORM.TeacherForm(request.POST, request.FILES, instance=teacher)
